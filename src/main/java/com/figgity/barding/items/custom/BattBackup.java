...
public class BattBackup extends InstrumentItem {
    public BattBackup(Item.Properties pProperties) {
        super(pProperties, 35);
    }

    @Override
    public ItemStack finishUsingItem(ItemStack pItemStack, Level pWorld, LivingEntity pLivingEntity) {
        MobEffectInstance effect = new MobEffectInstance(EffectInit.DEFENSE_INSPIRE.get(), 1000, 0);
