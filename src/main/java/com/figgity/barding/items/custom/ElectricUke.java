...
public class ElectricUke extends InstrumentItem{
    public ElectricUke(Properties pProperties) {
        super(pProperties, 35);
    }

    @Override
    public ItemStack finishUsingItem(ItemStack pItemStack, Level pWorld, LivingEntity pLivingEntity) {
        MobEffectInstance effect = new MobEffectInstance(EffectInit.SPEED_INSPIRE.get(), 1000, 0);
